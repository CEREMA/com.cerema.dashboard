					...
					[
						...
						{	// Eléments de la facture sélectionnée
							...
							columns: [
								...
								{header: "Service", 			width: 150, hidden: true, sortable: true, 	dataIndex: 'LibsubC'},
								{header: "Dpt", 				width: 150, hidden: true, sortable: true, 	dataIndex: 'LibUnic'},
						...
						{	// Eléments de la base de données infocentre2015
							...
							columns: [
								...
								{header: "Service", 			width: 150, hidden: true, sortable: true, 	dataIndex: 'LibSubC'},
								{header: "Dpt", 				width: 140, hidden: false, sortable: true, 	dataIndex: 'LibUnic'},
								{header: "Objet Motivation", 	width: 150, hidden: false, sortable: true, 	dataIndex: 'motivation_demande'},
